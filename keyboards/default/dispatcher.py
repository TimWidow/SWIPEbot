    ...
    'LEVEL_1:LEVEL_2': {
        ...
        'LEVEL_2_HOUSES:LEVEL_3_MY_HOUSES': {
            ...
            'LEVEL_3_MY_HOUSES:LEVEL_4_HOUSES': {
                ...
                'LEVEL_4_ADD_NEWS': user_keyboards.get_level_4_add_news,
                'LEVEL_4_ADD_DOC': user_keyboards.get_level_4_add_doc
            }
        },
...
menu_label = {
    'LEVEL_1': 'Главное меню',
    'LEVEL_2_POSTS': 'Список публикаций',
    'LEVEL_3_FILTER_POSTS': 'Фильтрация объявлений',
    'LEVEL_2_HOUSES':'Дома',
}
